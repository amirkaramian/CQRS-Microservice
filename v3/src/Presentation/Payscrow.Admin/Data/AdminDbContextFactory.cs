...
namespace Payscrow.Admin.Data
{
    ...
    public class AdminDbContextFactory : IDesignTimeDbContextFactory<AdminDbContext>
    {
        ...
        {
            var migrationsAssembly = typeof(AdminDbContext).GetTypeInfo().Assembly.GetName().Name;

            var optionsBuilder = new DbContextOptionsBuilder<AdminDbContext>();
            optionsBuilder.UseSqlServer("Server=sqldata;Database=payscrow.admin.db;User Id=sa;Password=Pass@word;",
