        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StreetAddress = table.Column<string>(maxLength: 300, nullable: true),
                    City = table.Column<string>(maxLength: 100, nullable: true),
                    State = table.Column<string>(maxLength: 100, nullable: true),
                    BusinessAccount = table.Column<bool>(nullable: false),
                    Suspended = table.Column<bool>(nullable: false),
                    Deleted = table.Column<bool>(nullable: false),
                    DeletePurgeUtc = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicationUserAccounts_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationUserAccounts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserAccounts_AccountId",
                table: "ApplicationUserAccounts",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserAccounts_UserId",
                table: "ApplicationUserAccounts",
                column: "UserId");
