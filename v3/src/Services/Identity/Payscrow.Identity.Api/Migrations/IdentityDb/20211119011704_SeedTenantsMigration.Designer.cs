...
namespace Payscrow.Identity.Api.Migrations.IdentityDb
{
    ...
    [Migration("20211119011704_SeedTenantsMigration")]
    partial class SeedTenantsMigration
    {
            ...
            modelBuilder.Entity("Payscrow.Identity.Api.Models.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateUtc = new DateTime(2021, 11, 19, 1, 17, 3, 252, DateTimeKind.Utc).AddTicks(7947),
                            DomainName = "host.docker.internal",
                            UpdateUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            UpdateUtc = new DateTime(2021, 11, 19, 1, 17, 3, 252, DateTimeKind.Utc).AddTicks(7947)
                        });
                });
